# 2026-W38 correction notice — amber-doubao: additive correction to published scores
...
- **Scope in one line**: 1 W38 vision cell is held; 3 ark-ds41 papers have no corresponding publication, so the public effect is the smallest of all repos.
...
|---|---|---|---|---|---|
| A-ea80d793 | `1d69841b029e` | W38 | main-table vision ✗ -2 (111s) | held (re-exam pending) | named and removed from the board; excluded from all aggregates pending re-exam |

> The 3 ark-ds41 papers have no scored publication in this repo or any other result repo, and do not enter the table.
